...
@app.route('/')
def exercise1():
    return 'Hello Karthik Subramanian!'
...
# they got design page in pen and pencil but have not wiritten any code to make the orsentation has_app_contextwirte code is import_main_pathafter implementation
# after implementation - run experiement, do with hartline online market class
# getting visualizations implemented, implement design
# afterwards we can interview students that have used perpal and gather their feedaback